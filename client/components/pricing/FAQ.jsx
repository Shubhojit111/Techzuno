...
export default function FAQ({ data = [] }) {
  ...
  return (
    <section className="w-full relative z-10 pt-32 pb-24 px-6 md:px-10 lg:px-62 mx-auto">
      <div className="flex flex-col items-center mb-16 text-center">
        <SectionTitle
          title={<>FREQUENTLY <span className="text-[#03B8B8]">ASKED</span><br /><span className="text-[#03B8B8]">QUESTIONS</span> ABOUT PRICES</>}
        />
      </div>

            ...
            <div className="bg-linear-to-b from-[#1a2121] to-[#121414] rounded-[16px] p-6 md:px-20 md:py-16 lg:px-8 lg:py-10 border border-[#2f3b3b] shadow-2xl h-full flex flex-col">
              ...
              >
                <div className="flex flex-col gap-2">
                  <label className="text-white/80 text-[13px] md:text-[14px]">
                  ...
                  <div className="relative">
                    <select
                      value={form.inquiry}
                      onChange={(event) =>
                        updateField("inquiry", event.target.value)
                      }
                    ...
                    >
                      ...
                      <option className="bg-[#111414]" value="Services">
                        Services
                      </option>
                      <option className="bg-[#111414]" value="Support">
                        Support
                      </option>
                      <option className="bg-[#111414]" value="Partnership">
                        Partnership
                      </option>
                    </select>
                    <Icon
                      icon="mdi:chevron-down"
                      className="absolute right-4 top-1/2 -translate-y-1/2 text-white/50 text-xl pointer-events-none"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-4">
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      className="w-full bg-[#181d1d] text-white/90 border border-[#2f3b3b] rounded-[6px] px-4 py-3.5 outline-none focus:border-[#03B8B8] transition-colors text-[13px] placeholder-white/50"
                    />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="text-white/80 text-[13px] md:text-[14px]">
                    ...
                    <input
                      ...
                      placeholder="Eg: johndoe88@Gmail.Com"
                      className="w-full bg-[#181d1d] text-white/90 border border-[#2f3b3b] rounded-[6px] px-4 py-3.5 outline-none focus:border-[#03B8B8] transition-colors text-[13px] placeholder-white/50"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#181d1d] text-white/90 border border-[#2f3b3b] rounded-[6px] px-4 py-3.5 outline-none focus:border-[#03B8B8] transition-colors text-[13px] placeholder-white/50 resize-none"
                  ></textarea>
                </div>
                ...
                <div className="flex items-center gap-3 mt-2">
                  <div className="relative flex items-center justify-center">
                    ...
                    <Icon
                      icon="mdi:check"
                      className="absolute text-white text-[13px] pointer-events-none"
                    />
                  </div>

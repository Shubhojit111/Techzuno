...
export const metadata = {
  ...
  description:
    "Insights on web development, app development, UI/UX, and SEO from the Techzuno team - practical guidance for growing your business online.",
...
export default async function BlogPage() {
  ...
  return (
    <main className="flex flex-col bg-black min-h-screen">
      <BlogHero />
      <BlogSections blogs={blogs} loading={false} />
    </main>
  );
}

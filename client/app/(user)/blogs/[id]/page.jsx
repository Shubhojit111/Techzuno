...
export default function BlogDetailPage() {
  ...
  return (
    <main className="flex flex-col bg-black min-h-screen text-white font-sans">
      <section className="relative w-full h-[400px] sm:h-[500px] lg:h-screen flex flex-col justify-center pt-40 md:pt-52 lg:pt-26 pb-10 md:pb-16 lg:pb-20 overflow-hidden">
      ...
      <article className="w-full mx-auto px-6 pt-14 pb-20 md:pt-20 md:pb-28">
        <div
